...
func (t *Transaction) legacyMarshalSia(w io.Writer) (err error) {
...
// legacyUnmarshalSia unmarshals a transactions from the legacy binary encoded version.
func (t *Transaction) legacyUnmarshalSia(r io.Reader) (err error) {
