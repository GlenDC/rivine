...
const (
	...
	genesisOutputSeed = "three unknown fetch wing letter goose code quit shallow hazard endorse amateur secret waste crucial dose frame laundry romance tilt essay abstract ready record"
